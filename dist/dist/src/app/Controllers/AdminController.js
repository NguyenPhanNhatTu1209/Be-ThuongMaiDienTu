    ...
    try {
      ...
      if (result != null) {
        ...
        if (roleDT == "ADMIN") {
          ...
          if (check != null) {
            var resultDN = await GoiDoanhNghiep.findOneAndUpdate({ _id: idGoiDoanhNghiep }, updateValue, {
              new: true
            });
            res.status(200).send({
              data: resultDN,
    ...
    try {
      ...
      if (result != null) {
        ...
        if (roleDT == "ADMIN") {
          ...
          if (check != null) {
            var resultKH = await GoiKhachHang.findOneAndUpdate({ _id: idGoiKhachHang }, updateValue, {
              new: true
            });
            res.status(200).send({
              data: resultKH,
    ...
    try {
      ...
      if (result != null) {
        ...
        if (roleDT == "ADMIN") {
          ...
          if (check != null) {
            var resultKH = await GoiDoanhNghiep.findOneAndUpdate({ _id: idGoiDoanhNghiep }, updateValue, {
              new: true
            });
            res.status(200).send({
              data: resultKH,
          ...
          if (check != null) {
            ...
            smtpTransport.sendMail(mailOptions, async function (error, response) {
              if (error) {
                ...
                var resultKH = await DoanhNghiep.findOneAndUpdate({ _id: idDoanhNghiep }, updateValue, {
                  new: true
                });
                res.status(200).send({
                  Data: resultKH,
    ...
    try {
      ...
      if (result != null) {
        ...
        if (roleDT == "ADMIN") {
          ...
          var resultKH = await KhachHang.findOneAndUpdate({ _id: idKH }, updateValue, {
            new: true
          });
          res.status(200).send({
            data: resultKH,
    ...
    try {
      ...
      if (result != null) {
        ...
        if (roleDT == "ADMIN") {
          ...
          var resultDN = await DoanhNghiep.findOneAndUpdate({ _id: idKH }, updateValue, {
            new: true
          });
          res.status(200).send({
            data: resultDN,
  ...
  async UpdateProductType(req, res, next) {
    try {
      ...
      if (result != null) {
        const roleDT = result.Role;
        if (roleDT == "ADMIN") {
          var resultLoaiSanPham = await LoaiHangHoaSanPham.findOneAndUpdate({ _id: _idLoaiSanPham }, updateValue, {
            new: true
          });
          res.status(200).send({
            data: resultLoaiSanPham,
